const functionsData = [
    {
        ...
        "color": "blue",
        "functions": [
            {"level": "basic", "equation": "x", "points": [{"x": 0}, {"x": -2}]},
            ...
            {"level": "high", "equation": "3x-2", "points": [{"x": -1}, {"x": 2}]},
            {"level": "high", "equation": "-2x+4", "points": [{"x": 1}, {"x": 3}]},
            {"level": "medium", "equation": "0.5x-1", "points": [{"x": 0}, {"x": 2}]},
            {"level": "medium", "equation": "5/3x-2", "points": [{"x": 0}, {"x": 3}]},
            {"level": "high", "equation": "3/5x-2", "points": [{"x": -5}, {"x": 5}]},
            {"level": "medium", "equation": "2/5x", "points": [{"x": 0}, {"x": 1, "labeled": true}]},
            {"level": "medium", "equation": "-2", "points": [{"x": 0}, {"x": 3}]},
            {"level": "high", "equation": "-(5/2)x-3/2", "points": [{"x": 0, "labeled": true}, {"x": -3}]},
            {"level": "medium", "equation": "3", "points": [{"x": -2}, {"x": 2}]},
            {"level": "high", "equation": "7/4x+1", "points": [{"x": 0}, {"x": 3, "labeled": true}]},
            {"level": "high", "equation": "(-1/3)x-0.5", "points": [{"x": -3, "labeled": true}, {"x": 4, "labeled": true}]},
            {"level": "high", "equation": "-x+4", "points": [{"x": -1}, {"x": 3}]},
            {"level": "high", "equation": "-1x+2", "points": [{"x": -2}, {"x": 2}]},
    ...
    },
    {
        ...
        "color": "mediumblue",
        "functions": [
            {"level": "high", "equation": "x^2", "points": [{"x": -2}, {"x": 0}]},
            {"level": "high", "equation": "x^2 + 2x + 1", "points": [{"x": -1}, {"x": 1}]},
            {"level": "high", "equation": "5(x-5)^2-3", "points": [{"x": 5}, {"x": 6}], "boundingbox": [-2, 7, 12, -7]},
            {"level": "high", "equation": "-0.5x^2", "points": [{"x": 0}, {"x": 2}]},
            {"level": "high", "equation": "x^2 - 4x + 4", "points": [{"x": 0}, {"x": 2}]},
            ...
            {"level": "high", "equation": "-x^2 + 6x - 5", "points": [{"x": 3}, {"x": 0}]},
            {"level": "high", "equation": "0.5x^2 + 2x + 1", "points": [{"x": -4}, {"x": -2}]},
            {"level": "high", "equation": "x^2 - 2x + 3", "points": [{"x": 1}, {"x": 2}]},
            {"level": "high", "equation": "-2x^2 - 4x + 1", "points": [{"x": -1}, {"x": 1}]},
            {"level": "high", "equation": "-x^2", "points": [{"x": 0}, {"x": 1}]},
            {"level": "high", "equation": "-(3/2)x^2", "points": [{"x": 0}, {"x": 2}]},
            {"level": "high", "equation": "(4/5)x^2", "points": [{"x": 0}, {"x": 1, "labeled": true}]},
            {"level": "high", "equation": "3x^2 - 5", "points": [{"x": 0}, {"x": 2}]},
    ...
    },
    {
        ...
        "functions": [
            ...
            {"level": "high", "equation": "-2 cos(pi x)", "points": [{"x": 0}, {"x": 2}]},
            {
