const functionsData = [
    ...
    },
    {
        ...
        "functions": [
            ...
            {"equation": "e^(x+1)", "points": [[-2, 0.3679], [0, 2.7183], [2, 20.0855]], "boundingbox": [-3, 25, 3, 0]},
    ...
    },
    {
        ...
        "color": "darkgreen",
        "functions": [
            {"equation": "log(x)", "points": [[-1, -1], [0, 0]], "boundingbox": [-3, 3, 3, -3]},
            {"equation": "log(x, 2)", "points": [[-1, -1], [2, 0.5]], "boundingbox": [-3, 3, 3, -3]},
            {"equation": "log(x, 0.5)", "points": [[-2, 0.25], [1, 1]], "boundingbox": [-3, 3, 3, -3]}
        ]
    },
    {
        "id": "trigonometric",
